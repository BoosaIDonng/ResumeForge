    ...
    <div className="max-w-2xl mx-auto py-12 px-4">
      ...
      <div className="flex items-center justify-between mt-6">
        ...
        {currentIndex < questions.length - 1 ? (
          <button
            onClick={() => setCurrentIndex((i) => i + 1)}
            className="rounded-lg bg-primary px-4 py-2 text-sm text-white font-medium hover:bg-primary-hover transition-colors"
          >
            下一题
          </button>
        ) : (
          allAnswered && (
            <button
              ...
              className="rounded-lg bg-success px-4 py-2 text-sm text-white font-medium hover:bg-success/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              生成面试反馈
            </button>
          )
