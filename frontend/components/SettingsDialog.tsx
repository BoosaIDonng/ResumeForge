        ...
        <div className="flex border-b border-border">
          {tabDefs.map((t) => (
            <button
              ...
              className={`flex items-center gap-1.5 px-6 py-2.5 text-sm font-medium transition-colors border-b-2 -mb-px ${
                tab === t.key
        ...
        <div className="px-6 py-5 max-h-[60vh] overflow-y-auto">
          {tab === "ai" && (
            <div className="space-y-5">
              ...
              <div className="flex items-center gap-3 pt-1">
                <button onClick={handleSaveAI} className="bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground hover:bg-primary-hover transition-colors">
                  保存设置
                </button>
                {savedKey === "ai" && <span className="text-sm font-medium text-success">已保存</span>}
              </div>
            </div>
          )}
          ...
          {tab === "appearance" && (
            <div className="space-y-5">
              ...
              <div className="flex items-center gap-3 pt-1">
                <button onClick={handleSaveAppearance} className="bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground hover:bg-primary-hover transition-colors">
                  保存设置
                </button>
                {savedKey === "appearance" && <span className="text-sm font-medium text-success">已保存</span>}
              </div>
            </div>
          )}
          ...
          {tab === "editor" && (
            <div className="space-y-5">
              ...
              <div className="flex items-center gap-3 pt-1">
                <button onClick={handleSaveEditor} className="bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground hover:bg-primary-hover transition-colors">
                  保存设置
                </button>
                {savedKey === "editor" && <span className="text-sm font-medium text-success">已保存</span>}
              </div>
            </div>
          )}
        </div>
